                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('meter/store') }}">
                       ...
                       {{-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="rated_current" class="col-md-4 col-form-label text-md-right">{{ 'Rated Current (A)' }}</label>

                            <div class="col-md-6">
                                <input id="rated_current" type="number" class="form-control{{ $errors->has('rated_current') ? ' is-invalid' : '' }}" name="rated_current" value="{{ old('rated_current') }}" required >
                                @if ($errors->has('rated_current'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('rated_current') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ip_address" type="text" class="form-control{{ $errors->has('ip_address') ? ' is-invalid' : '' }}" name="ip_address" value="{{ old('ip_address') }}" required >
